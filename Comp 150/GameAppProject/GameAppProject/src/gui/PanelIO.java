...
public class PanelIO {
	...
	private final static int WIDTH = 51; // of JTextArea output; the units for this are really off
	private final static int HEIGHT = 40; // of JTextArea output; the units for this are really off
	...
	private static JLabel inputLabel = new JLabel("What Will it Be?:");
