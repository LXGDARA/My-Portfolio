...
public class Game {
	...
	public static boolean timeForBoss = false; // field for testing whether we are going to be fighting a boss battle or not
	/**
	...
	/**
	 * In this method , I have setup all the animations for the various chapters.
	 */
...
//----------------------------------------------------------------------------------------------------------
	...
	static void gameLoop() {
		...
		while (!Narrator.isAtFinalChapter()) {
			setupAnimations();// This was the best place to put the setup animations
	...
	private static void iteration() {
		...
		if(Narrator.getChapter()%2 == 0){ // We are going to fight every other chapter
			...
			out.printFancyIO(Narrator.tell());
			if(Narrator.getChapter()-1 == 3){// for Odd chapters or chapter 3
				invtPromt();
	...
	/**
	 * This method prompts the player for their choice
	 * of weapon to add to the inventory
	 */
	...
	/**
	 * This method prints the contents of our players inventory
	 */
