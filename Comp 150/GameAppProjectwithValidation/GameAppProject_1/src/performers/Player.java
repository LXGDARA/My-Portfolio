...
public abstract class Player {
	...
	/**
	 * This methos allows us to set proper grammar based on how many foes we face.
	 * @param a
	 * The number of monsters we're facing
	 * @param b
	 * the dialogue for only 1 foe
	 * @param c
	 * the dialogue for multiple foes
	 * @return
	 */
